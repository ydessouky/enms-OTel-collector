...
package k8s // import "github.com/ydessouky/enms-OTel-collector/exporter/datadogexporter/internal/metadata/internal/k8s"
...
func (p *nodeNameProviderImpl) NodeName(ctx context.Context) (string, error) {
	...
	// https://github.com/ydessouky/enms-OTel-collector/issues/11033
