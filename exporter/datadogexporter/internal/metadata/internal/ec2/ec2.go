...
package ec2 // import "github.com/ydessouky/enms-OTel-collector/exporter/datadogexporter/internal/metadata/internal/ec2"
...
import (
	...
	ec2provider "github.com/ydessouky/enms-OTel-collector/internal/metadataproviders/aws/ec2"
)
...
func (p *Provider) instanceTags(ctx context.Context) (*ec2.DescribeTagsOutput, error) {
	...
	// Similar to:
	// - https://github.com/ydessouky/enms-OTel-collector/blob/39dbc1ac8/processor/resourcedetectionprocessor/internal/aws/ec2/ec2.go#L118-L151
