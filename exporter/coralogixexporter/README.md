...
OpenTelemetry Collector [resourcedetection](https://github.com/ydessouky/enms-OTel-collector/tree/main/processor/resourcedetectionprocessor) processor can discover EC2 Resource attributes, such as EC2 tags as resource attributes.
...
You can combine and create custom Resource attributes using [transform](https://github.com/ydessouky/enms-OTel-collector/tree/main/processor/transformprocessor) processor. For example:
```
    transform:
     logs:
       queries:
