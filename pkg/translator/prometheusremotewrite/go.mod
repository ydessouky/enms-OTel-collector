module github.com/ydessouky/enms-OTel-collector/pkg/translator/prometheusremotewrite
...
replace github.com/ydessouky/enms-OTel-collector/pkg/translator/prometheus => ../prometheus
