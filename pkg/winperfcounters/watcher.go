...
package winperfcounters // import "github.com/ydessouky/enms-OTel-collector/pkg/winperfcounters"

import (
	"fmt"
	"time"

	"github.com/ydessouky/enms-OTel-collector/pkg/winperfcounters/internal/third_party/telegraf/win_perf_counters"
)
