...
package file // import "github.com/ydessouky/enms-OTel-collector/pkg/stanza/operator/input/file"

import (
	"go.uber.org/zap"

	"github.com/ydessouky/enms-OTel-collector/pkg/stanza/fileconsumer"
