...
LABELS_COMMENT='See [Adding Labels via Comments](https://github.com/ydessouky/enms-OTel-collector/blob/main/CONTRIBUTING.md#adding-labels-via-comments) if you do not have permissions to add labels yourself.'
