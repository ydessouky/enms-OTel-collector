...
BUILD_INFO_IMPORT_PATH=github.com/ydessouky/enms-OTel-collector/internal/otelcontribcore/internal/version
VERSION=$(shell git describe --always --match "v[0-9]*" HEAD)
BUILD_INFO=-ldflags "-X $(BUILD_INFO_IMPORT_PATH).Version=$(VERSION)"

COMP_REL_PATH=internal/components/components.go
MOD_NAME=github.com/ydessouky/enms-OTel-collector
...
unit-tests-with-cover:
	...
	@internal/buildscripts/check-test-files.sh $(subst github.com/ydessouky/enms-OTel-collector/,./,$(ALL_PKGS))
...
COMMIT?=HEAD
MODSET?=contrib-core
REMOTE?=git@github.com:ydessouky/enms-OTel-collector.git
.PHONY: push-tags
push-tags:
	multimod verify
