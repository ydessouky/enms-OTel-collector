...
## OTTL
The [OpenTelemetry Transformation Language](https://github.com/ydessouky/enms-OTel-collector/blob/main/pkg/ottl/README.md) is a language for interacting with telemetry within the collector in generic ways.
...
| Config              | OTTL Context                                                                                                                       |
|---------------------|------------------------------------------------------------------------------------------------------------------------------------|
| `traces.span`       | [Span](https://github.com/ydessouky/enms-OTel-collector/blob/main/pkg/ottl/contexts/ottlspan/README.md)           |
| `traces.spanevent`  | [SpanEvent](https://github.com/ydessouky/enms-OTel-collector/blob/main/pkg/ottl/contexts/ottlspanevent/README.md) |
| `metrics.metric`    | [Metric](https://github.com/ydessouky/enms-OTel-collector/blob/main/pkg/ottl/contexts/ottlmetric/README.md)       |
| `metrics.datapoint` | [DataPoint](https://github.com/ydessouky/enms-OTel-collector/blob/main/pkg/ottl/contexts/ottldatapoint/README.md) |
| `logs.log_record`   | [Log](https://github.com/ydessouky/enms-OTel-collector/blob/main/pkg/ottl/contexts/ottllog/README.md)             |

The OTTL allows the use of `and`, `or`, and `()` in conditions.
See [OTTL Boolean Expressions](https://github.com/ydessouky/enms-OTel-collector/blob/main/pkg/ottl/README.md#boolean-expressions) for more details.

The filter processor has access to all the [factory functions of the OTTL](https://github.com/ydessouky/enms-OTel-collector/tree/main/pkg/ottl/ottlfuncs#ottl-functions) 
