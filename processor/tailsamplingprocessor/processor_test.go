...
func TestConcurrentTraceArrival(t *testing.T) {
	t.Skip("Flaky Test - See https://github.com/ydessouky/enms-OTel-collector/issues/10205")
	traceIds, batches := generateIdsAndBatches(128)
...
func TestConcurrentTraceMapSize(t *testing.T) {
	t.Skip("Flaky test, see https://github.com/ydessouky/enms-OTel-collector/issues/9126")
