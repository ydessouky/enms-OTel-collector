...
package common // import "github.com/ydessouky/enms-OTel-collector/processor/routingprocessor/internal/common"
...
func Functions[K any]() map[string]interface{} {
	return map[string]interface{}{
		...
		// see https://github.com/ydessouky/enms-OTel-collector/issues/13545
