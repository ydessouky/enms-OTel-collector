module github.com/ydessouky/enms-OTel-collector/receiver/purefareceiver
...
replace github.com/ydessouky/enms-OTel-collector/receiver/prometheusreceiver => ../prometheusreceiver
