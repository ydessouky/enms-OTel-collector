...
```bash
go build -ldflags "-X github.com/ydessouky/enms-OTel-collector/receiver/jmxreceiver.MetricsGathererHash=<sha256hash>" ...
```
...
```bash
go build -ldflags "-X github.com/ydessouky/enms-OTel-collector/receiver/jmxreceiver.MetricsGathererHash=<sha256hash>
       -X github.com/ydessouky/enms-OTel-collector/receiver/jmxreceiver.AdditionalTargetSystems=newtarget,othernewtarget" ...
```
